...
class MetricManager():
    ...
    that run in psnr (Peak Signal-to-Noise Ratio) and ssim (Structural Similarity Index Measurement).
    ...
    def __init__(self, original_images, generated_images):
        """
            ...
            :param original_images (Tensor.float32[] | NumPy<float32>: An array of tensor form of original image array.
            :param generated_images (Tensor.float32[]): An array of tensor form of generated image array.
        """
    ...
    def psnr(self) -> 'MetricManager':
        ...
        The PSNR is more standardized than MSE for scoring image differential.
